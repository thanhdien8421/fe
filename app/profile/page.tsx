    ...
    const fetchAllData = async () => {
      try {
        const [
          ...
          fetch(
            `http://localhost:8000/api/v1/certificates/${localStorage.getItem(
              "userId"
            )}`
          ),
          fetch(
            `http://localhost:8000/api/v1/educations/${localStorage.getItem(
              "userId"
            )}`
          ),
          fetch(
            `http://localhost:8000/api/v1/experiences/${localStorage.getItem(
              "userId"
            )}`
          ),
          fetch(
