          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <Card className="w-full md:max-w-[40rem] mx-3">
              ...
              <CardContent className="overflow-y-scroll h-[350px] px-7 py-5 flex flex-col gap-5">
                ...
                <Section title="Thư giới thiệu" Icon={SlEnvolopeLetter} description="Một thư giới thiệu ngắn gọn, chỉn chu sẽ giúp bạn trở nên chuyên nghiệp và gây ấn tượng hơn với nhà tuyển dụng.">
                  <FormField
                    control={form.control}
                    name="letter"
                    render={({ field }) => (
                  ...
                  <div className="border-[1px] min-h-[200px] p-3">
                    <div className="text-red-500 font-semibold flex gap-2 items-center"><CgDanger /><p>Lưu ý:</p></div>
                    <ol className="mt-3">
                      <li>
                        1. Chúng tôi khuyên tất cả các bạn hãy luôn cẩn trọng trong quá trình tìm việc và chủ động nghiên cứu về thông tin công ty, vị trí việc làm trước khi ứng tuyển.
                        Ứng viên cần có trách nhiệm với hành vi ứng tuyển của mình. Nếu bạn gặp phải tin tuyển dụng hoặc nhận được liên lạc đáng ngờ của nhà tuyển dụng, hãy báo cáo ngay cho chúng tôi qua email hotro@gmail.com để được hỗ trợ kịp thời.
                      </li>
                      <li>
                        2. Tìm hiểu thêm kinh nghiệm phòng tránh lừa đảo <a href="/" className="hover:underline text-cyan-600">tại đây</a>.
                      </li>
                    </ol>
                  </div>
                </Section>
